                        ...
                        <form class="form" method="post" id="addWebsiteChildMenu">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4 col-sm-6">
                                           <select id="main_menu_id" name="main_menu_id" class="select2 form-control custom-select" style="width: 100%; height:36px;" required="required">
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group m-t-10 row">
                                        ...
                                        <div class="col-md-4 col-sm-6">
                                           <select id="sub_menu_id" name="sub_menu_id" class="select2 form-control custom-select" style="width: 100%; height:36px;" required="required">
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group m-t-10 row">
                                        ...
                                        <div class="col-md-4 col-sm-6">
                                            <input  type="text" name="child_menu" class="form-control" autocomplete="off" required="required">
                                        </div>
                                    </div>
