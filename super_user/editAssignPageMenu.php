    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Assign Page Menu > Add</h4>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body" style="display: flex; ">
                        ...
                        <div class="col-12">
                            <form class="form" id="addAssignPage" method="post">
                            <input type="hidden" name="id" value="<?php echo $_GET["id"]; ?>">
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-4 col-md-2 col-form-label">Facility</label>
                                    <div class="col-md-8 col-sm-12">
                                        <select id="facility_id" name="facility_id" class="select2 form-control custom-select" style=" height:36px;">
                                ...
                                <div class="form-group m-t-10 row">
                                    ...
                                    <div class="col-md-8 col-sm-12">
                                        <select id="main_menu_id" name="main_menu_id" class="select2 form-control custom-select" style=" height:36px;">
                                            <option value="">Please Select</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group m-t-10 row">
                                    ...
                                    <div class="col-md-8 col-sm-12">
                                    <select name="link_name" id="link_name" class="select2 form-control custom-select" style="width: 100%; height:36px;"></select>
                                </div>
                            </div>
                            <div class="form-group m-t-10 row">
                                <label for="example-text-input" class="col-sm-4 col-md-2 col-form-label">Link Code</label>
                                <div class="col-md-8 col-sm-12">
                                    <input type="text" name="link_code" id="link_code" class="form-control" autocomplete="off">
                                </div>
                            </div>
                            <div class="form-group m-t-10 row">
                            ...
                            <div class="form-group m-t-10 row">
                                ...
                                <div class="col-md-8 col-sm-12">
                                    <select name="font_icon" id="font_icon" class="select2icon form-control custom-select" style="width: 100%; height:36px;">
                            ...
                            <div class="form-group m-t-10 row">
                                ...
                                <div class="custom-control custom-radio">
                                    <input type="radio"  name="status" id="status1"  value="1" class="custom-control-input">
                                    <label class="custom-control-label" for="status1">Active</label>
                                </div>&nbsp;&nbsp;
                                <div class="custom-control custom-radio">
                                    <input type="radio"  name="status" id="status" value="0" class="custom-control-input">
                                    <label class="custom-control-label" for="status">Deactive</label>
                                </div>
                            </div>
                            ...
                            <div class="form-group m-t-10 row">
                                ...
                                <div class="custom-control custom-radio">
                                    <input type="radio"  name="editable" id="editable1" value="1" class="custom-control-input">
                                    <label class="custom-control-label" for="editable1">Yes</label>
                                </div>&nbsp;&nbsp;
                                <div class="custom-control custom-radio">
                                    <input type="radio"  name="editable" id="editable" value="0" class="custom-control-input">
                                    <label class="custom-control-label" for="editable">No</label>
                                </div>
                            </div>
