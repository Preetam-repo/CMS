	...
	<div class="container-fluid">
		...
		<div class="row page-titles">
			<div class="col-md-5 align-self-center">
				<h4 class="text-themecolor">Our Services > Add</h4>
			</div>
		</div>
		<!-- .row -->
		<div class="row">
			<div class="col-sm-12">
				<div class="card">
					<div class="card-body">
						<form class="form" id="addServices">
                                    ...
                                    <div class="form-group m-t-10 row">
                                        <label for="example-text-input" class="col-2 col-form-label">Tag line</label>
                                        <div class="col-10">
                                            <input type="text" class="form-control" name="tag_line">
                                        </div>
                                    </div>
									<div class="form-group m-t-10 row">
                                        <label for="example-text-input" class="col-2 col-form-label">Background Image Upload</label>
                                        <div class="col-10">
                                            <input type="file" class="form-control" name="bg_img[img]">
                                        </div>
                                    </div>
									
                            <div class="form-group m-t-10 row">
                                <label for="example-text-input" class="col-2 col-form-label">Icon</label>
                                <div class="col-10 dropdown bootstrap-select">
                                    <select name="icon" class="select2icon form-control custom-select" style="width: 100%; height:36px;">
									...
									<div class="form-group m-t-10 row">
                                        ...
                                        <label for="example-text-input" class="col-2 col-form-label">Link Name 1</label>
                                        <div class="col-10">
                                            <input type="text" class="form-control" name="link_name1">
                                        </div>
                                    </div><div class="form-group m-t-10 row">
                                        <label for="example-text-input" class="col-2 col-form-label">Button Name 2</label>
                                        <div class="col-10">
                                            <input type="text" class="form-control" name="btn_name2">
                                        </div>
                                    </div>
									<div class="form-group m-t-10 row">
                                        <label for="example-text-input" class="col-2 col-form-label">Link Name 2</label>
                                        <div class="col-10">
                                            <input type="text" class="form-control" name="link_name2">
                                        </div>
                                    </div>
                                    <div class="form-group m-t-10 row">
