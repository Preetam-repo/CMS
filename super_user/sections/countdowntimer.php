<?php include '../include/header.php'; ?>
        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Countdown > Table</h4>
                </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="toolbar">
                                <a class="btn btn-success" style="color:#fff" href="addCountdownTimer">
    ...
    <script type="text/javascript">
            var bodyOrder = {};
            bodyOrder['Active From'] = "activation_from";
            bodyOrder['Active To'] = "activation_upto";
            bodyOrder['Category'] = "category";
            bodyOrder['Last Date'] = "last_date";
            bodyOrder['Name'] = "name";
            bodyOrder['SRN'] = "srn";
