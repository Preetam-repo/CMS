	...
	<div class="container-fluid">
		...
		<div class="row page-titles">
			<div class="col-md-5 align-self-center">
				<h4 class="text-themecolor">Facility > Edit</h4>
			</div>
		</div>
			...
			<div class="col-sm-12">
				<div class="card">
					<div class="card-body">
						...
						<form class="form" id="addFacility">
                            <input type="hidden" name="id" value="<?php echo $_GET["id"]; ?>">
							<div class="form-group row">
								<label for="example-text-input" class="col-2 col-form-label">Facility Name</label>
								<div class="col-10">
									<input type="text" name="facility_name" id="facility_name" class="form-control" autocomplete="off">
								</div>
							</div>
							<div class="form-group m-t-10 row">
								<label for="example-text-input" class="col-2 col-form-label">Facility Folder</label>
								<div class="col-10">
									<input type="text" name="facility_folder" id="facility_folder" class="form-control" autocomplete="off">
								</div>
							</div>
							<div class="form-group m-t-10 row">
								<label for="example-text-input" class="col-2 col-form-label">Primary Page Name</label>
								<div class="col-10">
									<input type="text" name="primary_page_name" id="primary_page_name" class="form-control" autocomplete="off">
								</div>
							</div>
							<div class="form-group m-t-10 row">
							...
							<div class="form-group m-t-10 row">
								<label for="example-text-input" class="col-2 col-form-label">Lable for User</label>
								<div class="col-10">
									<input type="text" name="lable" id="lable" class="form-control" autocomplete="off">
								</div>
							</div>
							<div class="form-group m-t-10 row">
