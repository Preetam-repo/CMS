							...
							<div class="tab-content">
								<div class="tab-pane active" id="info1" role="tabpanel">
									...
									<div class="form-group m-t-10 row">
										...
										<div class="col-10">
											<input type="text" class="form-control" name="site_info[webmaster_email]" id="site_infowebmaster_email" id="webmaster_email" >
										</div>
									</div>
									<div class="form-group m-t-10 row">
										<label for="example-text-input" class="col-2 col-form-label">Copyright</label>
										<div class="col-10">
											<input type="text" class="form-control" name="site_info[copyright]" id="site_infocopyright" id="copyright" >
										</div>
									</div>
									<div class="form-group m-t-10 row">
										<label for="example-text-input" class="col-2 col-form-label">Description</label>
										<div class="col-10">
											<input type="text" class="form-control" name="site_info[description]" id="site_infodescription" id="description" >
										</div>
									</div>
								...
								<div class="tab-pane" id="info2" role="tabpanel">
									<div class="form-group m-t-10 row">
										...
										<div class="col-10">
											<input type="text" class="form-control" name="contacts[address]" id="contactsaddress" id="address" >
										</div>
									</div>
									<div class="form-group m-t-10 row">
										<label for="example-text-input" class="col-2 col-form-label">Longitude</label>
										<div class="col-10">
											<input type="text" class="form-control" name="contacts[longitude]" id="contactslongitude" id="longitude" >
										</div>
									</div>
									<div class="form-group m-t-10 row">
										<label for="example-text-input" class="col-2 col-form-label">Latitude</label>
										<div class="col-10">
											<input type="text" class="form-control" name="contacts[latitude]" id="contactslatitude" id="latitude" >
										</div>
									</div>
									<div class="form-group m-t-10 row">
										<label for="example-text-input" class="col-2 col-form-label">Google MAP</label>
										<div class="col-10">
											<input type="text" class="form-control" name="contacts[google_map]" id="contactsgoogle_map" id="google_map" >
										</div>
									</div>
									<div class="form-group m-t-10 row">
										<label for="example-text-input" class="col-2 col-form-label">Phone</label>
										<div class="col-10">
											<input type="text" class="form-control" name="contacts[phone]" id="contactsphone" id="phone" >
										</div>
									</div>
									<div class="form-group m-t-10 row">
										<label for="example-text-input" class="col-2 col-form-label">Working Time</label>
										<div class="col-10">
											<input type="text" class="form-control" name="contacts[working_time]" id="contactsworking_time" id="working_time" >
										</div>
									</div>
								</div>
								<div class="tab-pane" id="info3" role="tabpanel">
									<div class="form-group m-t-10 row">
										...
										<div class="col-6">
											<input type="text" class="form-control" name="social_links[facebook]" id="social_linksfacebook" id="facebook" >
										</div>
									...
									<div class="form-group m-t-10 row">
										...
										<div class="col-6">
											<input type="text" class="form-control" name="social_links[googleplus]" id="social_linksgoogleplus" id="googleplus" >
										</div>
										<div class="col-2 dropdown bootstrap-select">
									...
									<div class="form-group m-t-10 row">
										...
										<div class="col-6">
											<input type="text" class="form-control" name="social_links[instagram]" id="social_linksinstagram" id="instagram" >
										</div>
										<div class="col-2 dropdown bootstrap-select">
									...
									<div class="form-group m-t-10 row">
										...
										<div class="col-6">
											<input type="text" class="form-control" name="social_links[linkedin]" id="social_linkslinkedin" id="linkedin" >
										</div>
										<div class="col-2 dropdown bootstrap-select">
									...
									<div class="form-group m-t-10 row">
										...
										<div class="col-6">
											<input type="text" class="form-control" name="social_links[pinterest]" id="social_linkspinterest" id="pinterest" >
										</div>
										<div class="col-2 dropdown bootstrap-select">
									...
									<div class="form-group m-t-10 row">
										...
										<div class="col-6">
											<input type="text" class="form-control" name="social_links[snapchat]" id="social_linkssnapchat" id="snapchat" >
										</div>
										<div class="col-2 dropdown bootstrap-select">
									...
									<div class="form-group m-t-10 row">
										...
										<div class="col-6">
											<input type="text" class="form-control" name="social_links[tumbler]" id="social_linkstumbler" id="tumbler" >
										</div>
										<div class="col-2 dropdown bootstrap-select">
									...
									<div class="form-group m-t-10 row">
										...
										<div class="col-6">
											<input type="text" class="form-control" name="social_links[twitter]" id="social_linkstwitter" id="twitter" >
										</div>
										<div class="col-2 dropdown bootstrap-select">
									...
									<div class="form-group m-t-10 row">
										...
										<div class="col-6">
											<input type="text" class="form-control" name="social_links[whatsapp]" id="social_linkswhatsapp" id="whatsapp" >
										</div>
										<div class="col-2 dropdown bootstrap-select">
									...
									<div class="form-group m-t-10 row">
										...
										<div class="col-6">
											<input type="text" class="form-control" name="social_links[youtube]" id="social_linksyoutube" id="youtube" >
										</div>
										<div class="col-2 dropdown bootstrap-select">
								...
								<div class="tab-pane" id="info4" role="tabpanel">
									<div class="form-group m-t-10 row">
										...
										<div class="col-10">
											<input type="text" class="form-control" name="style_master[website_notification]" id="style_masterwebsite_notification" id="website_notification" >
										</div>
									</div>
									<div class="form-group m-t-10 row">
									...
									<div class="form-group m-t-10 row">
										...
										<div class="col-10">
											<select name="style_master[footer_background]" id="style_masterfooter_background" class="select2 form-control custom-select " style="width: 100%; height:36px;">
												<option value="">Please select</option>
											</select>
										</div>
									</div>
								...
								<div class="tab-pane" id="info5" role="tabpanel">
									<div class="form-group m-t-10 row">
										...
										<div class="col-10">
											<input type="text" class="form-control" name="email_notifications[email_notifications]" id="email_notificationsemail_notifications" id="email_notifications" >
										</div>
									</div>
								</div>
								...
								<div class="tab-pane" id="info6" role="tabpanel">
									<div class="form-group m-t-10 row">
										...
										<div class="col-10">
											<input type="text" class="form-control" name="newsletter[heading]" id="newsletterheading" id="heading" >
										</div>
									</div>
									<div class="form-group m-t-10 row">
										<label for="example-text-input" class="col-2 col-form-label">Sub Heading</label>
										<div class="col-10">
											<input type="text" class="form-control" name="newsletter[sub_heading]" id="newslettersub_heading" id="sub_heading" >
										</div>
									</div>
									<div class="form-group m-t-10 row">
