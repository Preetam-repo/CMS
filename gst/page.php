...
curl_setopt_array($curl, [
    ...
    CURLOPT_URL => $webpage,
    CURLOPT_POST => 1,
    CURLOPT_POSTFIELDS => ['page' => $_GET["page"],"aoId" => $aoId]
  ]);
    ...
    <div class="row"> 
      ...
      <div class="page-title-name">
          ...
          <ul class="page-breadcrumb">
            <li><a href="<?php echo $site_url; ?>"><i class="fa fa-home"></i> Home</a> <i class="fa fa-angle-double-right"></i></li>
            <li><a href="<?php echo $site_url; ?>page/<?php echo $page->link; ?>"><?php echo $page->header; ?></a></li>
       </ul>
     </div>
     </div>
  </div>
