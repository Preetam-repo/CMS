$(document).ready(function () {
    ...
    $(".form_bal_upload").draggable({
        helper: function () {
            return getuloadFieldHTML();
        },
        connectToSortable: ".form_builder_area"
    });
    ...
    $(document).on('change', '.form_input_upload_label', function () {
        getPreview();
    });
    ...
    function getPreview(plain_html = '') {
        ...
        el.each(function () {
            ...
            // if (data_type === 'file') {
            //     var btn_class = $(this).find('.form_input_upload_label').val();
            //     var btn_value = $(this).find('.form_input_button_value').val();
            //     html += '<button name="' + name + '" type="submit" class="' + btn_class + '">' + btn_value + '</button>';
            // }

            if (data_type === 'file') {
                var name = $(this).find('.form_input_upload_name').val();
                var checkbox = $(this).find('.form-check-input');
                var required = '';
                if (checkbox.is(':checked')) {
                    required = 'required';
                ...
                html += '<div class="form-group"><label class="control-label" for="myfile">' + label + '</label><input type="file" id="' + name + '"  name="' + name + '" class="form-control" ' + required + '/></div>';
            }
            if (data_type === 'select') {
                var option_html = '';
