	...
	<div class="container-fluid">
		...
		<div class="row page-titles">
			<div class="col-md-5 align-self-center">
				<h4 class="text-themecolor">Facility > Add</h4>
			</div>
		</div>
					...
					<div class="card-body">
						...
						<form class="form" id="addFacility">
							<div class="form-group row">
								...
								<div class="col-10">
									<input type="text" name="facility_name" class="form-control" autocomplete="off">
								</div>
							</div>
							<div class="form-group m-t-10 row">
								<label for="example-text-input" class="col-2 col-form-label">Facility Folder</label>
								<div class="col-10">
									<input type="text" name="facility_folder" class="form-control" autocomplete="off">
								</div>
							</div>
							<div class="form-group m-t-10 row">
								<label for="example-text-input" class="col-2 col-form-label">Primary Page Name</label>
								<div class="col-10">
									<input type="text" name="primary_page_name" class="form-control" autocomplete="off">
								</div>
							</div>
							<div class="form-group m-t-10 row">
							...
							<div class="form-group m-t-10 row">
								...
								<div class="col-10">
									<input type="text" name="lable" class="form-control" autocomplete="off">
								</div>
							</div>
							<div class="form-group m-t-10 row">
