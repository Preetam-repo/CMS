					...
					<div class="card-body">
						<form class="form" id="addFaq">
							<div class="form-group m-t-10 row">
								<label for="example-text-input" class="col-2 col-form-label">Faq Category</label>
								<div class="col-10">
									<select name="faqCategory" id="faqCategory" class="select2-tags form-control custom-select" style="width: 100%; height:36px;" required="required">
									</select>
								</div>
							</div>
							<div class="form-group m-t-10 row">
