            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="form" method="post" id="addWebsiteSubMenu">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4 col-sm-6">
                                           <select name="main_menu_id" id="main_menu_id" class="select2 form-control custom-select" style="width: 100%; height:36px;">
                                    ...
                                    <div class="form-group m-t-10 row">
                                        ...
                                        <div class="col-md-4 col-sm-6">
                                            <input  type="text" name="sub_menu" id="sub_menu" class="form-control" autocomplete="off">
                                        </div>
                                    </div>
                            ...
                            <div class="form-group m-t-10 row">
                                ...
                                <div class="col-10">
                                    <input type="text" name="links" id="links" class="form-control" autocomplete="off" required="required">
                                </div>
                            </div>
