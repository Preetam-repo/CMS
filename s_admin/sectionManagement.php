							...
							<div class="form-group m-t-10 row">
								...
								<div class="col-10">
									<select id="servicessection_style" name="services[section_style]" class="select2 form-control custom-select" style="width: 100%; height:36px;">
										...
										<option value="services/services4.php">Services4</option>
										<option value="services/services5.php">Services5</option>
										<option value="services/services6.php">Services6</option>
										<option value="services/services7.php">Services7</option>
									</select>
								</div>
							</div>
							<div class="form-group m-t-10 row">
								...
								<div class="form-group m-t-10 row">
									...
									<div class="col-10">
										<select id="featuressection_style" name="features[section_style]" class="select2 form-control custom-select" style="width: 100%; height:36px;">
											...
											<option value="features/features4.php">Features4</option>
										</select>
									</div>
								</div>
								<div class="form-group m-t-10 row">
											...
											<div class="form-group m-t-10 row">
												...
												<div class="col-10">
													<select id="teamssection_style" name="teams[section_style]" class="select2 form-control custom-select" style="width: 100%; height:36px;">
														...
														<option value="team/teamDark.php">Team Dark</option>
														<option value="team/teamDefault.php">Team Default</option>
														<option value="team/teamHover.php">Team Hover</option>
														<option value="team/teamList.php">Team List</option>
														<option value="team/teamOverlay.php">Team Overlay</option>
														<option value="team/teamRound.php">Team Round</option>
														<option value="team/teamRoundFullBorder.php">Team Round Full Border</option>
														<option value="team/teamRoundSmall.php">Team Round Small</option>
														<option value="team/teamShadow.php">Team Shadow</option>
													</select>
												</div>
											</div>
											<div class="form-group m-t-10 row">
												...
												<div class="form-group m-t-10 row">
													...
													<div class="col-10">
														<select id="client_testimonialssection_style" name="client_testimonials[section_style]" class="select2 form-control custom-select" style="width: 100%; height:36px;">
															...
															<option value="testimonials/testimonial04.php">Client Testmonials04</option>
															<option value="testimonials/testimonial05.php">Client Testmonials05</option>
															<option value="testimonials/testimonial06.php">Client Testmonials06</option>
														</select>
													</div>
												</div>
												<div class="form-group m-t-10 row">
													...
													<div class="form-group m-t-10 row">
														...
														<div class="col-10">
															<select id="clientsection_style" name="client[section_style]" class="select2 form-control custom-select" style="width: 100%; height:36px;">
																...
																<option value="client/clientCaraousel.php">Client Casrousel</option>
																<option value="client/clientFullwidth.php">Client Fullwidth</option>
																<option value="client/clientGrayscale.php">Client Grayscale</option>
																<option value="client/clientGrayscaleDark.php">Client Grayscale Dark</option>
															...
															<div class="form-group m-t-10 row">
																...
																<div class="col-10">
																	<select id="countersection_style" name="counter[section_style]" class="select2 form-control custom-select" style="width: 100%; height:36px;">
																		...
																		<option value="counter/counter04.php">Counter04</option>
																		<option value="counter/counter05.php">Counter05</option>
																		<option value="counter/counter06.php">Counter06</option>
																		<option value="counter/counter07.php">Counter07</option>
																		<option value="counter/counter08.php">Counter08</option>
																	</select>
																</div>
															</div>
															<div class="form-group m-t-10 row">
																	...
																	<div class="form-group m-t-10 row">
																		...
																		<div class="col-10">
																			<select id="faqsection_style" name="faq[section_style]" class="select2 form-control custom-select" style="width: 100%; height:36px;">
																				...
																				<option value="faq/faq04.php">Faq 04</option>
																			</select>
																		</div>
																	</div>
																	<div class="form-group m-t-10 row">
