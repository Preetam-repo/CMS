    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Sub Menu > Edit</h4>
            </div>
        </div>
                        ...
                        <form class="form" method="post" id="addSubMenu">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <select id="main_menu_id" name="main_menu_id" id="main_menu_id" class="select2 form-control custom-select" style="width: 100%; height:36px;">
