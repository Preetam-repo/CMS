    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Main Menu > Add</h4>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="form" method="post" id="addMainMenu">
                            
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-4 col-md-2 col-form-label">Facility</label>
                                    <div class="col-md-8 col-sm-12">
                                        <select id="facility_id" name="facility_id" class="select2 form-control custom-select" style="width: 100%;height:36px;">
                                            <option value="">Please select</option>
                                        </select>
                                    </div>
                                </div>
                            <div class="form-group m-t-10 row">
                                <label for="example-text-input" class="col-2 col-form-label">Main Menu Category</label>
                                <div class="col-10">
                                    <input type="text" name="main_menu" class="form-control" autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="form-group m-t-10 row">
                                <label for="example-text-input" class="col-2 col-form-label">Font Icon</label>
                                <div class="col-10">
