    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Main Menu > Edit</h4>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <form class="form" method="post" id="addMainMenu">
                            ...
                            <div class="form-group m-t-10 row">
                                ...
                                <div class="col-10">
                                    <input type="text" id="main_menu" name="main_menu" class="form-control" autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="form-group m-t-10 row">
                                ...
                                <div class="col-10">
                                    <input type="text" id="srn" name="srn" class="form-control" autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="form-group m-t-10 row">
                                ...
                                <div class="col-10">
                                    <input type="text" id="menu" name="menu" class="form-control" autocomplete="off">
                                </div>
                            </div>
