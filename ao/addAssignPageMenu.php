                        ...
                        <div class="col-12">
                            <form class="form" id="addAssignPage" method="post">
                                ...
                                <div class="form-group m-t-10 row">
                                    ...
                                    <div class="col-md-8 col-sm-12">
                                        <select name="link_name" id="link_name" class="select2-tags form-control custom-select" style="width: 100%; height:36px;"></select>
                                    </div>
                                </div>
                                <div class="form-group m-t-10 row">
                                    <label for="example-text-input" class="col-sm-4 col-md-2 col-form-label">Link Code</label>
                                    <div class="col-md-8 col-sm-12">
                                        <input type="text" name="link_code" class="form-control" autocomplete="off">
                                    </div>
                                </div>
                                <div class="form-group m-t-10 row">
