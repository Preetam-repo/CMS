<script type="text/javascript">
    const aoId = <?php echo $_SESSION['UserData']->id; ?>;
    const loginLink = "<?php echo $_SESSION['UserData']->loginLink; ?>";
...
<script src="<?php echo $base_url; ?>ao/controller/facilityMaster.js"></script>
<script src="<?php echo $base_url; ?>ao/controller/mainMenuMaster.js"></script>
<script src="<?php echo $base_url; ?>ao/controller/subMenuMaster.js"></script>
<script src="<?php echo $base_url; ?>ao/controller/assignPageMaster.js"></script>
<script src="<?php echo $base_url; ?>ao/controller/websiteManagement.js"></script>
<script src="<?php echo $base_url; ?>ao/controller/websiteMainMenu.js"></script>
<script src="<?php echo $base_url; ?>ao/controller/websiteSlider.js"></script>
<script src="<?php echo $base_url; ?>ao/controller/importMaster.js"></script>
<script src="<?php echo $base_url; ?>ao/controller/websitePages.js"></script>
<script src="<?php echo $base_url; ?>ao/controller/userMaster.js"></script>
<script src="<?php echo $base_url; ?>ao/controller/rolesMaster.js"></script>
<script src="<?php echo $base_url; ?>ao/controller/aoMaster.js"></script>
<script src="<?php echo $base_url; ?>ao/controller/ppm.js"></script>
<script src="<?php echo $base_url; ?>ao/controller/notification.js"></script>