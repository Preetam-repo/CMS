    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Faq > Table</h4>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div id="toolbar">
                            <a class="btn btn-success" style="color:#fff" href="addFaq">
                                <i class="ti-plus"></i> Add
                            </a>
                            <a class="btn btn-success" style="color:#fff" href="categoryFaq">FAQ Categories</a>
                        </div>
                        <table id="table"
...
var bodyOrder = {};
bodyOrder['SRN'] = "srn";
bodyOrder['Category'] = "faqCategory";
bodyOrder['Answer'] = "answer";
bodyOrder['Question'] = "question";
