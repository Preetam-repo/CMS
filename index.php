...
$featureStyle = json_decode($sectionStyle->features);
$socialLinks = json_decode($resp->style_master->social_links);
$articles = $resp->articles;
$client = $resp->client;
$faq = $resp->faq;
$clienttestimonial = $resp->clienttestimonial;
$counter = $resp->counter;
$counterStyle = json_decode($sectionStyle->counter);
$clienttestimonialStyle = json_decode($sectionStyle->client_testimonials);
$clientStyle = json_decode($sectionStyle->client);
$faqStyle = json_decode($sectionStyle->faq);
$articleStyle = json_decode($sectionStyle->articles);
}
 ?>
<!DOCTYPE html>
<html lang="en">
